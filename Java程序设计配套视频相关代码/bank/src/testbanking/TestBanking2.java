...
public class TestBanking2 {
	...
	public static void main(String[] args) {
		...
		//存款
		System.out.println("客户["+c1.getLastName()+c1.getFisrtName()+"]"+"存钱100.0元");
		c1.getAccount().deposit(100.0);
		
		//取款
		System.out.println("客户["+c1.getLastName()+c1.getFisrtName()+"]"+"取钱20.0元");
